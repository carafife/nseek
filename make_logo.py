...
<circle cx="198" cy="22" r="3.5" fill="#5ab4f0" opacity="0.7"/>
<circle cx="268" cy="20" r="3" fill="#5ab4f0" opacity="0.7"/>
</g>
...
path = os.path.expanduser('~/Programmes/assets/nseek-logo.svg')
with open(path, 'w') as f:
    f.write(svg)
print(f"SVG écrit : {os.path.getsize(path)} octets")
